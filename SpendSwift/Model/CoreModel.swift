...
final class CoreModel {
    ...
    private let directory = "xyz.preludeandfuge.spendswift"
    private let sqliteFile = "SpendSwift.sqlite"
    ...
    private lazy var applicationDocumentsDirectory: Foundation.URL = {
        ...
        print(appSupportURL.absoluteString)
        return appSupportURL.appendingPathComponent(directory)
    }()
    ...
    private lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        if failError == nil {
            ...
            let url = self.applicationDocumentsDirectory.appendingPathComponent(sqliteFile)
            do {
